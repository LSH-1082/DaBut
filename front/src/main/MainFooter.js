...
const MainFooter = () => {
    ...
    const clickMainFooterButton = (value) => {
        ...
        if(value === "alarmPage") navigate("/alarm");
        ...
        <nav className="MainNav">
            <div className="MainFooterDiv">
                <div className="MainFooter">
                    <svg onClick={() => {clickMainFooterButton("mainPage")}} className="mainFooterHome" xmlns="http://www.w3.org/2000/svg" width="24" height="22"
                    ...
                    <svg onClick={() => {clickMainFooterButton("listPage")}} className="mainFooterList" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                    ...
                    <div className="footerCircle">
                        ...
                        <svg onClick={() => {clickMainFooterButton("???")}} className="plusInCircle" xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                    ...
                    <svg onClick={() => {clickMainFooterButton("alarmPage")}} className="mainFooterAlarm" xmlns="http://www.w3.org/2000/svg" width="20" height="22"
                    ...
                    <svg onClick={() => {clickMainFooterButton("profilePage")}} className="mainFooterProfile" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
